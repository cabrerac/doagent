...
not every tool is relevant for every run:
  ...
  interpretability.get_explanations_for(record_id, run_id, ...)  # when you have decision/explanation records
...
- **Interpretability**: use when you care about explanations for outcomes; requires
  linked agent_update or explanation records.
