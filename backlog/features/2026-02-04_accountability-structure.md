...
## Acceptance Criteria
- [x] Accountability type is defined with optional owner, policy_id, responsibility_scope.
- [x] Type is documented and exported from records.
...
### 2026-02-05
Accountability TypedDict added with optional fields; exports updated in `doagent.records`.
